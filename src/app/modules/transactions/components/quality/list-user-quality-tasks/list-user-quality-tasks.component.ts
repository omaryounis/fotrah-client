...
import { UserQualityWorkflowComponent } from "../user-quality-workflow/user-quality-workflow.component";

@Component({
  selector: "app-user-list-quality-tasks",
  standalone: true,
  imports: [
    TableComponent,
    SearchBarComponent,
  ...
  templateUrl: "./list-user-quality-tasks.component.html",
  styleUrl: "./list-user-quality-tasks.component.scss",
})
export class ListUserQualityTasksComponent {
    ...
    return [
      {
        ...
        component: UserQualityWorkflowComponent,
      },
    ];
  }
