  ...
  constructor(private route :ActivatedRoute){
   ...
   if (this.billType == 'violations') {
     this.cardItems = [
      ...
      { image: 'assets/images/icons/mokhalfat.svg', routerLink: `/dashboard/features/${this.billType}/refund-request`, title: "refund-request" , action : 'Request' , resource : 'Refund' },
